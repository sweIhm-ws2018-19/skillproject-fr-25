...
public class SpeechStringsTest {
    ...
    public void testInitializeQuestions(){
        ...
        array[1][0]="In welchem Jahr wurde die Bundesrepublik Deutschland gegründet?";
        array[1][1]="1949";
        array[1][2]="DatumJahr";

        array[2][0]="Wie lautet die chemische Formel für Ozon? <break time=\"1s\"/> Antwort A: O Z <break time=\"1s\"/> Antwort B: O 2 <break time=\"1s\"/> Antwort C: O 4 <break time=\"1s\"/> Antwort D: O 3";
        array[2][1]="Antwort D";
        array[2][2]="Antwort";
        ...
        array[4][0]="Im Schlussverkauf gibt es 40% Rabatt. Wieviel bezahlst du für einen Mantel, der vorher 120 € gekostet hat?";
        array[4][1]="72";
        array[4][2]="Nummer";
        ...
        array[7][0]="Wie heißt der höchste Berg Österreichs? <break time=\"1s\"/> Antwort A: Zugspitze  <break time=\"1s\"/> Antwort B: Großglockner <break time=\"1s\"/> Antwort C: Wildspitze <break time=\"1s\"/> Antwort D: Dachstein ";
        array[7][1]="Antwort B";
        array[7][2]="Antwort";
