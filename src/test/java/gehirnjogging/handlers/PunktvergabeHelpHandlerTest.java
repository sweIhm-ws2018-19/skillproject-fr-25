...
public class PunktvergabeHelpHandlerTest{
	PunktvergabeHelpHandler handler = new PunktvergabeHelpHandler();
    ...
    public void testHandle() {
        ...
        assertTrue(response.getOutputSpeech().toString().contains("ie Punktvergabe ist ganz einfach,"));
    }
