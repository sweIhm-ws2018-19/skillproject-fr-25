...
public class RegelHandlerTest{
	RegelHandler handler = new RegelHandler();
    ...
    public void testHandle() {
        ...
        assertTrue(response.getOutputSpeech().toString().contains("t du etwas über den Spielablauf oder die Punktver"));
    }
